...
//        props.put(ConsumerConfig.GROUP_ID_CONFIG, "gatewaygroupid");
    ...
    public ConsumerFactory<String, CatDTO> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfigs(), (Deserializer) new StringDeserializer(), new JsonDeserializer<>(CatDTO.class));
    }
